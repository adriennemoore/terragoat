...
resource "aws_rds_cluster" "app2-rds-cluster" {
  ...
  tags = {
    ...
    git_org              = "adriennemoore"
    git_repo             = "terragoat"
    yor_trace            = "8c4836dd-701f-48fc-ac1c-ba0d37c5036d"
  }
}
...
resource "aws_rds_cluster" "app3-rds-cluster" {
  ...
  tags = {
    ...
    git_org              = "adriennemoore"
    git_repo             = "terragoat"
    yor_trace            = "97826777-1f59-40de-89e4-988d0e70ca5e"
  }
}
...
resource "aws_rds_cluster" "app4-rds-cluster" {
  ...
  tags = {
    ...
    git_org              = "adriennemoore"
    git_repo             = "terragoat"
    yor_trace            = "798639da-c675-4579-8413-85d04fda2cb0"
  }
}
...
resource "aws_rds_cluster" "app5-rds-cluster" {
  ...
  tags = {
    ...
    git_org              = "adriennemoore"
    git_repo             = "terragoat"
    yor_trace            = "0dcbf35c-ba51-4b88-a8ae-ef3d5a347d46"
  }
}
...
resource "aws_rds_cluster" "app6-rds-cluster" {
  ...
  tags = {
    ...
    git_org              = "adriennemoore"
    git_repo             = "terragoat"
    yor_trace            = "413960fc-58d7-4c86-93ef-b5b7703a1b38"
  }
}
...
resource "aws_rds_cluster" "app7-rds-cluster" {
  ...
  tags = {
    ...
    git_org              = "adriennemoore"
    git_repo             = "terragoat"
    yor_trace            = "2660e5c5-d767-4e12-883a-e0b7c51a463d"
  }
}
...
resource "aws_rds_cluster" "app8-rds-cluster" {
  ...
  tags = {
    ...
    git_org              = "adriennemoore"
    git_repo             = "terragoat"
    yor_trace            = "a1c31140-8226-40a4-85b9-92d369e24b94"
  }
}
...
resource "aws_rds_cluster" "app9-rds-cluster" {
  ...
  tags = {
    ...
    git_org              = "adriennemoore"
    git_repo             = "terragoat"
    yor_trace            = "a9a68f43-d2be-498b-8bab-da1533dce2be"
  }
}
